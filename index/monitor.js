...
function renderLayer03Right(){
	drawLayer03Right($("#layer03_right_chart01 canvas").get(0),"#027825",0.66,'300');
	drawLayer03Right($("#layer03_right_chart02 canvas").get(0),"#006DD6",0.52,'100');
	drawLayer03Right($("#layer03_right_chart03 canvas").get(0),"#238681",0.34,'12');
	drawLayer03Right($("#layer03_right_chart04 canvas").get(0),"#740278",0.34,'20');
	drawLayer03Right($("#layer03_right_chart05 canvas").get(0),"#0032d6",0.34,'28');
	drawLayer03Right($("#layer03_right_chart06 canvas").get(0),"#598623",0.34,'70');
}

function drawLayer03Right(canvasObj,colorValue,rate,value){
	var ctx = canvasObj.getContext("2d");
